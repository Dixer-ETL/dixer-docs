...
|----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| [github.com/360EntSecGroup-Skylar/excelize](https://github.com/360EntSecGroup-Skylar/excelize)           | [v2.4.1](https://github.com/360EntSecGroup-Skylar/excelize/tree/v2.4.1)                                              |                                                                             | [BSD 3-Clause "New" or "Revised" License](dependencies-licenses/LICENSE-excelize.txt)             |
...
| [github.com/godror/godror](https://github.com/godror/godror)                                             | [v0.25.4](https://github.com/godror/godror/tree/v0.25.4)                                                             |                                                                             | [UPL-1.0](dependencies-licenses/LICENSE-godror.txt)                                               |
...
| [github.com/mattn/go-sqlite3](https://github.com/mattn/go-sqlite3)                                       | [v1.14.8](https://github.com/mattn/go-sqlite3/tree/v1.14.8)                                                          |                                                                             | [MIT License](dependencies-licenses/LICENSE-go-sqlite3.txt)                                       |
...
| [github.com/nakagami/firebirdsql](https://github.com/nakagami/firebirdsql)                               | [v0.9.2](https://github.com/nakagami/firebirdsql/tree/v0.9.2)                                                        |                                                                             | [MIT License](dependencies-licenses/LICENSE-firebirdsql.txt)                                      |
...
| [github.com/SAP/go-hdb](https://github.com/SAP/go-hdb)                                                   | [v0.105.3](https://github.com/SAP/go-hdb/tree/v0.105.3)                                                              |                                                                             | [Apache License 2.0](dependencies-licenses/LICENSE-go-hdb.txt)                                    |
